...
class ImageCanvas extends Canvas {
     ...
     * 
     * @param bytes the byte array with the each element being an 8bit RGB tuple
    ...
    public void readImage(byte[] bytes, int width, int height) {
        ...
        for (index = 0; index < pix.length - 2; index++) {
            pix[index] =
                    255 << 24 /* alpha */| (bytes[ofs] & 0xFF) << 16 /* R */| (bytes[ofs] & 0xFF) << 8 /* G */
                            | (bytes[ofs] & 0xFF) /* B */;
            ofs += 1;
        }
     ...
     * Image displayed from the given array.
     * 
     * @param doubles the double array with the each element being an 64bit RGB tuple. The alpha color is reset to FF
     *            and only the 24bits (from left to right of each element are displayed).
     * @param width The width of the iamge
     * @param height The height of the image
     */
     ...
     * Image displayed from the given array.
     * 
     * @param int the int array with the each element being an 32bit RGB tuple. No conversion done.
     * @param width The width of the iamge
     * @param height The height of the image
     */
