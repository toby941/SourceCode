...
public class Quorum {
	...
	public String toString() {
		return "Quorum [host=" + host + ", version=" + version + ", latencyMin=" + latencyMin + ", latencyMax="
				+ latencyMax + ", latencyAvg=" + latencyAvg + ", received=" + received + ", sent=" + sent
				+ ", outstanding=" + outstanding + ", zxid=" + zxid + ", mode=" + mode + ", nodeCount=" + nodeCount
