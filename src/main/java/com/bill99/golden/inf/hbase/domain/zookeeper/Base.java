package com.bill99.golden.inf.hbase.domain.zookeeper;
...
public class Base {
	...
	public String toString() {
		return "Base [hdfsRoot=" + hdfsRoot + ", masterAddress=" + masterAddress + ", backupMasterAddress="
				+ backupMasterAddress + ", regionServerHoldingRoot=" + regionServerHoldingRoot + ", regionServers="
				+ regionServers + ", updateTime=" + updateTime + ", quorums=" + quorums + "]";
	}
